...
<head>
    <meta charset="utf-8">
    <title>Zadanie 3 - Strona autora</title>
    <style>
        body {
...
<div class="card">
    ...
    <p>Strona dostępna pod adresem:<br>
        http://szuflandia.pjwstk.edu.pl/~<?= htmlspecialchars($numerIndeksu, ENT_QUOTES, 'UTF-8') ?>/file.php
    </p>
</div>
</body>
</html>
